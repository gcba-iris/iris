...
const loader = new LiftOff({
    ...
    v8flags: [
        process.env.NODE_STACK_SIZE || '--stack_size=8192',
        process.env.NODE_MAX_OLD_SPACE_SIZE || '--max_old_space_size=8192',
        process.env.NODE_MAX_NEW_SPACE_SIZE || '--max_new_space_size=2048'
    ]
});

...
const installDependencies = () => {
    const spinner = ora('Running \'npm install\'');
...
const checkPackageFile = () => {
    const spinner = ora('Checking package.json');
...
const createIrisfile = () => {
    const spinner = ora('Creating Irisfile');
 ...
 */
const installIris = () => {
    const spinner = ora('Running \'npm install gcba-iris/iris --save\'');
